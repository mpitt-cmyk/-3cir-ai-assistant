(function() {
  ...
  function injectStyles() {
    ...
    css.textContent = `
      ...
      @media(max-width:480px){#cir-win{position:fixed;width:100vw;height:100%;max-height:100%;bottom:0;right:0;left:0;top:0;border-radius:0}#cir-header{padding:16px 12px 10px;padding-top:max(16px,calc(env(safe-area-inset-top) + 8px))}#cir-input-wrap{padding-bottom:max(12px,env(safe-area-inset-bottom))}#cir-header-close{font-size:32px;padding:8px;min-width:48px;min-height:48px;justify-content:center;-webkit-tap-highlight-color:rgba(0,0,0,0.1)}.cir-header-btn{min-width:44px;min-height:44px;font-size:24px;justify-content:center;-webkit-tap-highlight-color:rgba(0,0,0,0.1)}#cir-header-logo{width:36px;height:36px}#cir-header-logo img{width:28px;height:28px}#cir-header-name{font-size:14px}#cir-header-sub{font-size:11px}}
